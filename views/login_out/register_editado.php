...
<div class="form-group row">
    ...
    <input id="login_input_email" class="form-control" type="email" placeholder="EX: mtw-ecomerce@MTW.com" class="form-control" name="user_email" required />
    ...
    <input id="login_input_password_new" class="form-control" type="password" placeholder="min. 6 Caracteres" class="form-control" name="user_password_new" pattern=".{6,}" required autocomplete="off" />
 ...
 <div class="col-sm-12">
 <hr class="featurette-divider">
     <button type="submit" class="btn btn-success" name="register" value="Register">REGISTRAR</button>
    </div>
